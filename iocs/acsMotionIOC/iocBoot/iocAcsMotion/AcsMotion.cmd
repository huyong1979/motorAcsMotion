...
iocshLoad("$(MOTOR_ACSMOTION)/acsMotionApp/iocsh/ACS_Motion_tcp.iocsh", "INSTANCE=ACS1,IP_ADDR=10.69.34.65,NUM_AXES=16,IDLE_POLL=0.2")
#iocshLoad("$(MOTOR_ACSMOTION)/acsMotionApp/iocsh/ACS_Motion_tcp.iocsh", "INSTANCE=ACS2,IP_ADDR=10.69.34.66,NUM_AXES=8,IDLE_POLL=0.2")
